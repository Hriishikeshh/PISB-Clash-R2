...
function Navbar() {
  return (
    <div>
        <header className='top-0 left-0 w-full h-16 p-y-full p-x-20 flex justify-between items-center z-100'>
            <a href="#" className='px-10 text-3xl font-bold text-white drop-shadow-xl'>Credenz.</a>
